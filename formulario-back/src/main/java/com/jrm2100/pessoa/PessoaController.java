...
public class PessoaController {
    ...
    @PostMapping
    public ResponseEntity<PessoaDTO> cadastrarPessoa(@RequestBody PessoaDTO dto, UriComponentsBuilder uriBuilder) {
        try {
            ...
            return ResponseEntity.badRequest().body(new PessoaDTO("Erro ao processar a requisição: " + e.getMessage()));
        }
    }
